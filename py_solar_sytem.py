...
cwd = os.getcwd()
sun_path = f"{cwd}/resources/solar_system_assets/sun.png"
earth_path = f"{cwd}/resources/solar_system_assets/earth.png"
moon_path = f"{cwd}/resources/solar_system_assets/moon.png"
